...
- Submit a [Pull Request](https://www.github.com/PlagueHO/LoopbackAdapter/pulls) against the GitHub repository, containing:
  - Bug fixes
  - Enhancements
  - New sample Labs
  ...
  - Unit tests
- Perform user testing and validation, and report bugs on the [Issue Tracker](https://www.github.com/PlagueHO/LoopbackAdapter/issues)
...
Alternately, feel free to post on the [LoopbackAdapter PowerShell Module Gitter Chat at https://gitter.im/PlagueHO/LoopbackAdapter](https://gitter.im/PlagueHO/LoopbackAdapter). This is also a great place to just say Hi, ask any questions you might have or get help.
...
- All functions should exist in individual files under `/LoopbackAdapter/Libs/` in the
...
- Use markdown-based help inside the `/docs` folder which can be automatically generated
  ...
  ```powershell
  Import-Module -Name .\src\LoopbackAdapter.psd1
  New-MarkdownHelp -Module LoopbackAdapter -OutputFolder .\docs\
  ```
...
- Add meaningful title of the PR describing what change you want to check in. Don't simply put: "Fixes issue #5".
  Better example is: "Added All parameter to Get-LoopbackAdapterDatabase - Fixes #5".
